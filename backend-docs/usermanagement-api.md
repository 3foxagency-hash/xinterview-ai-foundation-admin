...
```jsonc
{
  ...
  "questions": [
    {
      "question_type": "text",
      "title": "Describe a challenging problem…",
      "options": null
    },
    {
...
```jsonc
{
  "factors": [
    ...
    },
    {
      ...
      "description": "Approaches problems…",
      "weight": 25
    },
    {
      "name": "Cultural fit",
      "description": "Aligns with team values…",
      "weight": 20
    }
  ]
}
...
entity a _customer_. Only `url` is read from its response.
...
| `GET /user-management/job-titles/`                              | _unchanged_                                                      | —                                                        |
...
> **Note on spec accuracy.** Three endpoints that _were_ in this section are now
