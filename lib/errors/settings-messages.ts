...
const SETTINGS_MESSAGES: Record<string, string> = {
  ...
  workspace_name_too_long: 'Workspace names are limited to 40 characters.',
  workspace_name_taken: 'You already have a workspace with that name.',
  company_title_required: 'Enter a company title.',
  threshold_out_of_range: 'The pass threshold must be between 0 and 100.',
  logo_type_invalid: 'Choose a PNG, JPG or SVG image.',
  logo_too_large: 'That image is over 2MB. Choose a smaller one.',
  logo_read_failed: "That image couldn't be read. Try another file.",
