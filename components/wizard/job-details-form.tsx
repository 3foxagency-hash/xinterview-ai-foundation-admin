...
import { JobFormatSelection } from './job-format-selection';
...
export function JobDetailsForm({
  ...
  const handleGenerate = async (): Promise<string | null> => {
    ...
    try {
      ...
      track('description_ai_generated', { title: formData.title });
      return desc;
    } catch {
      return null;
    } finally {
  ...
  const deadlineResolved = deadlineDate
    ? formatDate(deadlineDate, 'PPP')
    : null;
          ...
          >
            <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
              ...
              <div className="relative">
                  ...
                  {showTitleSuggestions && filteredSuggestions.length > 0 && (
                    <div
                      ...
                      className="absolute z-50 mt-1 w-full rounded-md border border-border bg-surface shadow-lg"
                    >
              ...
              <div>
                ...
                <div className="flex h-12 items-center rounded-md border border-border-strong bg-surface p-1">
